...
INSERT INTO public.categories (slug, name, description, icon, color, sort_order) VALUES
  ('cafes', 'Cafés', 'Coffee, tea, and cozy corners', 'Coffee', '#D98A6C', 1),
  ('bars', 'Bars & Cafés', 'Borrel, cocktails, and late nights', 'Wine', '#A78BFA', 2),
  ('shopping', 'Shopping', 'Boutiques, markets, and stores', 'ShoppingBag', '#60A5FA', 3),
  ('attractions', 'Attractions', 'Museums, monuments, and landmarks', 'Landmark', '#F59E0B', 4),
  ('parks', 'Parks & Nature', 'Green spaces and outdoor escapes', 'Trees', '#4ADE80', 5),
  ('hidden-gems', 'Hidden Gems', 'Off the beaten path', 'MapPin', '#FB7185', 6);
